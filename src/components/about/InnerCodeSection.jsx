      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 h-full flex flex-col lg:flex-row relative z-20">
        ...
        <div className="w-full lg:w-[35%] h-full flex flex-col pt-4 lg:pt-8 relative">
          ...
          <h2 className="font-display text-6xl lg:text-8xl leading-[0.85] tracking-tight mb-8">
            <div className="overflow-hidden pb-4 -mb-4"><div className="inner-title-word pr-4">OUR</div></div>
            <div className="overflow-hidden pb-4 -mb-4"><div className="inner-title-word pr-4">INNER</div></div>
            <div className="overflow-hidden relative inline-block pb-6 -mb-6">
              <div className="inner-title-word pr-4">CODE.</div>
